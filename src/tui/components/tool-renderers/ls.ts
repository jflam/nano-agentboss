...
export function renderLsToolCard(toolCall: UiToolCall, expanded: boolean): RenderedToolCard {
  let sections = appendSection([], blockSection("entries", toolCall.resultPreview, expanded, {
    collapsedLines: 10,
  }));
