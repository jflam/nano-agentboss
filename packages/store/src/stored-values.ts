import type { Continuation, KernelValue } from "@nanoboss/contracts";
...
export function publicContinuationFromStored(value: unknown): Continuation | undefined {
  return publicKernelValueFromStored(value) as Continuation | undefined;
}
