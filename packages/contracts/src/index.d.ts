...
export type JsonValue = KernelScalar | JsonValue[] | {
...
export declare function createRunRef(sessionId: string, runId: string): RunRef;
export declare function createRef(run: RunRef, path: string): Ref;
export declare function createSessionRef(sessionId: string): SessionRef;
export type KernelValue = KernelScalar | RunRef | Ref | KernelValue[] | object;
